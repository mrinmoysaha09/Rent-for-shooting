...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,size,price,location,city,state,pimage,pimage1,pimage3,uid,status)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$asize','$price',
	'$loc','$city','$state','$aimage','$aimage1','$aimage3','$uid','$status')";
