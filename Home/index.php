...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/sajek.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-primary">Let us</span><br>
                            Guide you for shooting</h1>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Instructions</h2></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Browse Listings:</a></h5>
                                <p>Start by browsing our extensive listings of available rentals. 
                            We offer a diverse range of options to suit your specific needs.
                             Use our search filters to narrow down your choices based on location,
                               type, and more...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Once you've found the perfect rental, click on the listing to view detailed information,
                             including photos, specifications, and rental terms. Take your time to review all the essential details.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Reserve Your Rental</a></h5>
                                <p>Ready to book? Simply click the "Reserve" button, and  You'll have
                                     the opportunity to select your rental dates, 
                                     agree to the terms and conditions, and make a secure payment.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#"> Enjoy Your Rental:</a></h5>
                                <p>Once your reservation is confirmed, you're all set! For land, equipment, palaces, and restaurants, 
                                    you'll have access to your rental as agreed upon. If you've reserved a car, pick it up at the designated location.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>🏡<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Price</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['12'];?></span>Price</li>
                                                ...
                                                <div class="p-4 d-inline-block w-100">
                                                    ...
                                                    <div class="float-right"><i class="far fa-calendar-alt text-primary mr-1"></i>one week ago</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> We take pride in offering an extensive 
                                            selection of top-rated rental options that cater to a variety of needs and preferences. </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Seamless Booking Experience</h5>
										<p>Our user-friendly website make it easy to browse, compare, and book your rental online.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Safety and Reliability</h5>
										<p> Your safety is our top priority.
                             palaces and restaurants, are chosen with your comfort and security in mind.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> Contact our dedicated customer support team or 
                                submit an inquiry through our website to discuss your specific requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Property surveys, vehicle specifications, equipment manuals, 
                                palace layouts, or restaurant menus,These resources will help you make informed decisions.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once you've made your choice, it's time to acquire your rental.
                              Complete rental agreements and payment done securely online for your convenience.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Upcoming Properties</h2></div>
                </div>
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/bike.jpg" alt="">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/arena1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/bojra2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/helicop1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where state='Dhaka'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
