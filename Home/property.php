                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Amount Calculator</h4>
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="Duration Days">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="interest" placeholder="Discount">
                            </div>
                            <button type="submit" value="submit" name="calc" class="btn btn-primary mt-4">Calclute Amount</button>
                        </form>
                        </div>
